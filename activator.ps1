...
class ZapModEngine {
    ...
    hidden [hashtable[]]$RouteTable = @(
        ...
        @{ Host = "backend-plugin.wascript.com.br";    Match = "^/api/urls/";             Dest = $null },
        ...
        @{ Host = "app-backend.wascript.com.br";       Match = "^/api/urls/";             Dest = $null },
        ...
        @{ Host = "code.wascript.com.br";              Match = "^/config\.json";          Dest = "/extension/waspeed/config.json" },
        @{ Host = "code.wascript.com.br";              Match = "^/";                      Dest = $null },
        @{ Host = "backend-utils.wascript.com.br";     Match = "^/";                      Dest = $null }
